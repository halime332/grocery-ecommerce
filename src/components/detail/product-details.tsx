...
import OrganicBage from "./organic-badge";
    ...
    return (
        <div className="md:flex">
            ...
            <div className="relative h-96 md:w-1/2">
                ...
                <OrganicBage isOrganic={grocery.isOrganic} />
            </div>
            {/* Product details */}
            <div className="md:w-1/2 p-6">
                ...
                <div className="flex justify-between items-start">
                    ...
                    <div className="flex items-center gap-1 bg-gray-200 px-3 py-1 rounded-full text-lg text-gray-700">
                        <TbWeight />
                ...
                <div className="mt-4">
                    ...
                    <p className="text-gray-600">KDV dahil</p>
                </div>

                <div className="my-6 bg-gray-200"></div>
