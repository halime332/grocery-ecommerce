    ...
    return (
        <div className="container mx-auto p-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-8 text-center">
                <FaShoppingCart className="text-6xl text-gray-300 mx-auto mb4" />
                ...
                <Link href="/" className="bg-green-600 text-white px-6 py-3 rounded-md font-medium hover:bg-green-700
                 transition mt-4 inline-block">
