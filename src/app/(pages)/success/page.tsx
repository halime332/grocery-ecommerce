        ...
        <div className="h-[80vh]">
            <div className="h-[50%] bg-green-500 text-white grid place-items-center">
                <div className="flex flex-col items-center gap-10">
                    ...
                    <p className="font-semibold text-4xl tetx-center">Ödeme Başarılı Oldu</p>
                </div>
            </div>
            ...
            <div className="h-[50%] p-10 mt-5 text-center text-black ">
                ...
                <Link href="/orders" className="border shadow py-2 px-5 rounded-lg text-lg hover:shadow-lg hover:bg-gray-100">Siparişlerim</Link>
